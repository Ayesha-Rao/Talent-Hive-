...
const { processPayment, getPaymentDetails, approvePayment, releasePayment,getFreelancerPayments } = require("../controllers/paymentController");
...
router.get("/freelancer", protect, authorizeRoles("independentFreelancer", "agencyFreelancer","agencyOwner"), getFreelancerPayments);
// ✅ Get Payment Details
