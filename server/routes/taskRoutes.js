...
const { createTask, getOpenTasks, getClientTasks, assignTask, completeTask,getTaskById } = require("../controllers/taskController");
...
router.get("/open", protect, authorizeRoles("independentFreelancer", "agencyOwner"), getOpenTasks);
router.get("/assigned", protect, authorizeRoles("independentFreelancer", "agencyFreelancer"), async (req, res) => {
    try {
...
router.post("/bid", protect, authorizeRoles("independentFreelancer", "agencyOwner"), (req, res) => {
...
router.post("/assign", protect, authorizeRoles("client", "agencyOwner"), assignTask);


// ✅ Freelancers can mark a task as completed
router.post("/complete", protect, authorizeRoles("independentFreelancer", "agencyFreelancer"), completeTask);
